...
pub type LLVMMemoryManagerFinalizeMemoryCallback =
    unsafe extern "C" fn(Opaque: *mut ::libc::c_void, ErrMsg: *mut *mut ::libc::c_char) -> LLVMBool;
pub type LLVMMemoryManagerDestroyCallback = Option<unsafe extern "C" fn(Opaque: *mut ::libc::c_void)>;
