...
pub type LLVMOrcErrorReporterFunction = unsafe extern "C" fn(Ctx: *mut ::libc::c_void, Err: LLVMErrorRef);
...
pub type LLVMOrcMaterializationUnitMaterializeFunction =
    unsafe extern "C" fn(Ctx: *mut ::libc::c_void, MR: LLVMOrcMaterializationResponsibilityRef);
...
pub type LLVMOrcMaterializationUnitDestroyFunction = unsafe extern "C" fn(Ctx: *mut ::libc::c_void);
...
/// is destroyed.
pub type LLVMOrcDisposeCAPIDefinitionGeneratorFunction = unsafe extern "C" fn(Ctx: *mut ::libc::c_void);

pub type LLVMOrcSymbolPredicate = Option<
    unsafe extern "C" fn(Ctx: *mut ::libc::c_void, Sym: LLVMOrcSymbolStringPoolEntryRef) -> ::libc::c_int,
>;
...
pub type LLVMOrcGenericIRModuleOperationFunction =
    unsafe extern "C" fn(Ctx: *mut ::libc::c_void, M: LLVMModuleRef) -> LLVMErrorRef;
...
pub type LLVMOrcObjectTransformLayerTransformFunction =
    unsafe extern "C" fn(Ctx: *mut ::libc::c_void, ObjInOut: *mut LLVMMemoryBufferRef) -> LLVMErrorRef;
