...
pub type LLVMMemoryManagerCreateContextCallback = unsafe extern "C" fn(CtxCtx: *mut ::libc::c_void);
pub type LLVMMemoryManagerNotifyTerminatingCallback = unsafe extern "C" fn(CtxCtx: *mut ::libc::c_void);
