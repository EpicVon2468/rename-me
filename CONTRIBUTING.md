...
This document outlines the expectations for any contributions to rename-me.  It is recommended you read this first as to avoid later confusion.

## General

### Use of "Artificial Intelligence" ("AI") / Large Language Models (LLMs)

> TL;DR: "Artificial Intelligence" ("AI") / Large Language Models (LLMs) are strictly prohibited from being used in contributions to rename-me.
